...
- `env -u CLAUDE_SESSION_ID -u CLAUDE_CODE_SESSION_ID -u CODEX_SESSION_ID -u CARTOGRAPHER_SESSION_ID node --test "tests/unit/*.test.js"` — 37 files, ~289 tests. Quote the glob; unset the session vars or delta serving eats repeat results.
